...
Relation* Operator::hashJoin(Relation* left, Relation* right, BitSet *left_w, BitSet *right_w, BitSet* width ) {
  ...
  cout << "hash join leftSize: " << leftSize << "rightSize: " << rightSize << endl;
	uint64_t m = 0, n = 0;
